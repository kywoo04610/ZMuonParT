## train_particle_transformer_v1.py
## Particle Transformer V1 학습 코드입니다.
## V1 pairwise features: delta_eta, delta_phi
## 실행 예:
## python train_particle_transformer_v1.py --epochs 5 --batch-size 4096 --lr 1e-4 --num-workers 4
...
def main():
    ...
    print("Model: ParticleTransformerV1")
    print("Pairwise features:", model_config["pairwise_features"])

    model = ParticleTransformerV1(**model_config).to(device)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if valid_loss < best_valid_loss:
            ...
            output_path = os.path.join(
                args.output_dir,
                "particle_transformer_v1_best.pt",
            )
